...
public class Textures {
	...
	private ObservableList<TextureDefinition> definitions;
	...
	public void startup(CustomTab tab, boolean refresh, int texture_id) {
		System.out.println("Starting up Texture editor");
		this.tab = tab;
		this.definitions = FXCollections.observableArrayList();
		this.definitions.addAll(TextureDiffuseLoader.getDefinitions());
		this.textures.setItems(this.definitions);
		addContextMenus();
		ContextMenu context_menu = new ContextMenu();
		textures.setContextMenu(context_menu);
	}
